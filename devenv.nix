...

{
  ...
  scripts = {
    ...
    '';
    dodge-ng-diagnose-actions.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
    ...
    dodge-ng-teacher.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
      exec uv run --extra native dodge-ng-teacher "$@"
    '';
    dodge-ng-bc.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
      exec uv run --extra native dodge-ng-bc "$@"
    '';
    dodge-ng-compare.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
      exec uv run --extra native dodge-ng-compare "$@"
    '';
    dodge-ng-dagger.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
    ...
    dodge-ng-hpo.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
      exec uv run --extra native dodge-ng-hpo "$@"
    '';
    dodge-ng-confirm.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
      exec uv run --extra native dodge-ng-confirm "$@"
    '';
    dodge-ng-overnight.exec = ''
      export LD_LIBRARY_PATH=${x11LibraryPath}:"$LD_LIBRARY_PATH"
      export PYTHONPATH="$PWD/src:''${PYTHONPATH:-}"
