...
[group("dodge")]
dodge-native-visual-compare *options:
...
[group("dodge")]
dodge-ng-diagnose-relevance *options:
    @mkdir -p history/dodge/ng/.launch-tmp
    @DODGE_HEADLESS=1 TMPDIR="$PWD/history/dodge/ng/.launch-tmp" devenv -q shell -- dodge-ng-diagnose-relevance {{ options }}
...
dodge-ng-bc *options:
    @mkdir -p history/dodge/ng/.launch-tmp
    @DODGE_HEADLESS=1 TMPDIR="$PWD/history/dodge/ng/.launch-tmp" devenv -q shell -- dodge-ng-bc {{ options }}

[group("dodge")]
dodge-ng-compare *options:
    @mkdir -p history/dodge/ng/.launch-tmp
    @DODGE_HEADLESS=1 TMPDIR="$PWD/history/dodge/ng/.launch-tmp" devenv -q shell -- dodge-ng-compare {{ options }}

[group("dodge")]
dodge-ng-dagger *options:
    @mkdir -p history/dodge/ng/.launch-tmp
